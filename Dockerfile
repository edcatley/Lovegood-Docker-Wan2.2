...
RUN comfy-node-install comfyui-videohelpersuite comfymath seedvr2_videoupscaler comfyui-frame-interpolation tripleksampler randomseedgenerator comfyui-unload-model comfyui-kimara-ai-advanced-watermarks comfy-gimm-vfi
